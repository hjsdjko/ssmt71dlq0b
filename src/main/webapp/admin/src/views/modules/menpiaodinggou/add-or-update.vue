	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="购票数量" prop="menpiaoshuliang">
					<el-input v-model.number="ruleForm.menpiaoshuliang" placeholder="购票数量" clearable  :readonly="ro.menpiaoshuliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="购票数量" prop="menpiaoshuliang">
					<el-input v-model="ruleForm.menpiaoshuliang" placeholder="购票数量" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="使用日期" prop="shiyongriqi">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.shiyongriqi" 
						type="date"
						:readonly="ro.shiyongriqi"
						placeholder="使用日期"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.shiyongriqi" label="使用日期" prop="shiyongriqi">
					<el-input v-model="ruleForm.shiyongriqi" placeholder="使用日期" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="购票时间" prop="goupiaoshijian">
					<el-date-picker
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.goupiaoshijian" label="购票时间" prop="goupiaoshijian">
					<el-input v-model="ruleForm.goupiaoshijian" placeholder="购票时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="购票备注" prop="goupiaobeizhu">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.goupiaobeizhu" label="购票备注" prop="goupiaobeizhu">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.goupiaobeizhu}}</span>
				</el-form-item>
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      ...
	      objcross.menpiaoshuliang = objcross.menpiaoshuliang - this.ruleForm.menpiaoshuliang
	      if(objcross.menpiaoshuliang<0){
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `menpiaodinggou/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.menpiaodinggouCrossAddOrUpdateFlag = false;
											this.parent.search();
