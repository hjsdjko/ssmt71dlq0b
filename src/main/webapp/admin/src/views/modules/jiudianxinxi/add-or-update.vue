<template>
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="酒店名称" prop="jiudianmingcheng">
					<el-input v-model="ruleForm.jiudianmingcheng" placeholder="酒店名称" clearable  :readonly="ro.jiudianmingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="酒店名称" prop="jiudianmingcheng">
					<el-input v-model="ruleForm.jiudianmingcheng" placeholder="酒店名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="酒店类型" prop="jiudianleixing">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="酒店类型" prop="jiudianleixing">
					<el-input v-model="ruleForm.jiudianleixing"
						placeholder="酒店类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-if="type!='info' && !ro.jiudiantupian" label="酒店图片" prop="jiudiantupian">
					<file-upload
						tip="点击上传酒店图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="upload" v-else-if="ruleForm.jiudiantupian" label="酒店图片" prop="jiudiantupian">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="星级评定" prop="xingjipingding">
					<el-select :disabled="ro.xingjipingding" v-model="ruleForm.xingjipingding" placeholder="请选择星级评定" >
						<el-option
							v-for="(item,index) in xingjipingdingOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="星级评定" prop="xingjipingding">
					<el-input v-model="ruleForm.xingjipingding"
						placeholder="星级评定" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="客房数量" prop="kefangshuliang">
					<el-input v-model.number="ruleForm.kefangshuliang" placeholder="客房数量" clearable  :readonly="ro.kefangshuliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="客房数量" prop="kefangshuliang">
					<el-input v-model="ruleForm.kefangshuliang" placeholder="客房数量" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="客房价格" prop="kefangjiage">
					<el-input-number v-model="ruleForm.kefangjiage" placeholder="客房价格" :disabled="ro.kefangjiage"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="客房价格" prop="kefangjiage">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="酒店地址" prop="jiudiandizhi">
					<el-input v-model="ruleForm.jiudiandizhi" placeholder="酒店地址" clearable  :readonly="ro.jiudiandizhi"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="酒店地址" prop="jiudiandizhi">
					<el-input v-model="ruleForm.jiudiandizhi" placeholder="酒店地址" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="酒店简介" prop="jiudianjianjie">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.jiudianjianjie" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.jiudianjianjie" label="酒店简介" prop="jiudianjianjie">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.jiudianjianjie"></span>
                </el-form-item>
...
export default {
	data() {
		...
		return {
			...
			ro:{
				...
				jiudiantupian : false,
				xingjipingding : false,
				kefangleixing : false,
				kefangshuliang : false,
				kefangjiage : false,
				lianxidianhua : false,
				jiudiandizhi : false,
				jiudianjianjie : false,
				thumbsupnum : false,
				crazilynum : false,
				clicktime : false,
				clicknum : false,
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='xingjipingding'){
							this.ruleForm.xingjipingding = obj[o];
							this.ro.xingjipingding = true;
							continue;
						}
						if(o=='kefangleixing'){
						...
						if(o=='jiudianjianjie'){
							this.ruleForm.jiudianjianjie = obj[o];
							this.ro.jiudianjianjie = true;
							continue;
						}
						if(o=='thumbsupnum'){
            ...
            this.xingjipingdingOptions = "★★★★★,★★★★,★★★,★★,★".split(',')
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.jiudianjianjie = this.ruleForm.jiudianjianjie.replace(reg,'../../../ssmt71dlq0b/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
