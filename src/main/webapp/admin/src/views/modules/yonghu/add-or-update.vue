	...
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="select" v-if="type!='info'"  label="个人喜好" prop="jingdianfenlei">
					<el-select :disabled="ro.jingdianfenlei" v-model="ruleForm.jingdianfenlei" placeholder="请选择个人喜好" >
						<el-option
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="个人喜好" prop="jingdianfenlei">
					<el-input v-model="ruleForm.jingdianfenlei"
						placeholder="个人喜好" readonly></el-input>
				</el-form-item>
			</template>
