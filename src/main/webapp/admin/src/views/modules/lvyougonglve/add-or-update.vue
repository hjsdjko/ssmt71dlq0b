<template>
	<div class="addEdit-block" :style='{"padding":"30px"}'>
		...
		>
			<template >
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="攻略标题" prop="gonglvebiaoti">
					<el-input v-model="ruleForm.gonglvebiaoti" placeholder="攻略标题" clearable  :readonly="ro.gonglvebiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="攻略标题" prop="gonglvebiaoti">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="交通工具" prop="jiaotonggongju">
					<el-input v-model="ruleForm.jiaotonggongju" placeholder="交通工具" clearable  :readonly="ro.jiaotonggongju"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="交通工具" prop="jiaotonggongju">
					<el-input v-model="ruleForm.jiaotonggongju" placeholder="交通工具" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="费用预算" prop="feiyongyusuan">
					<el-input-number v-model="ruleForm.feiyongyusuan" placeholder="费用预算" :disabled="ro.feiyongyusuan"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="费用预算" prop="feiyongyusuan">
					<el-input v-model="ruleForm.feiyongyusuan" placeholder="费用预算" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="行程天数" prop="xingchengtianshu">
					<el-input v-model.number="ruleForm.xingchengtianshu" placeholder="行程天数" clearable  :readonly="ro.xingchengtianshu"></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="行程天数" prop="xingchengtianshu">
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-if="type!='info'"  label="攻略详情" prop="gonglvexiangqing">
					<editor 
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.gonglvexiangqing" label="攻略详情" prop="gonglvexiangqing">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.gonglvexiangqing"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='feiyongyusuan'){
							this.ruleForm.feiyongyusuan = obj[o];
							this.ro.feiyongyusuan = true;
							continue;
						}
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.gonglvexiangqing = this.ruleForm.gonglvexiangqing.replace(reg,'../../../ssmt71dlq0b/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
