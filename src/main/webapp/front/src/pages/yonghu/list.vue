...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"12px 6px","margin":"172px 0 0","borderColor":"#ddd","alignItems":"center","display":"flex","clear":"both","float":"right","justifyContent":"center","borderRadius":"12px","flexWrap":"wrap","background":"#fff","borderWidth":"0 0 0px","width":"380px","borderStyle":"solid","height":"auto","order":"1"}'>
      <el-form-item :style='{"width":"100%","margin":"0 0 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"120px","padding":"0 0 0 0px","lineHeight":"42px","textAlign":"right","display":"inline-block"}'>账号：</div>
        <el-input v-model="formSearch.zhanghao" placeholder="账号" @keydown.enter.native="getList(1, curFenlei)" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"width":"100%","margin":"0 0 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"120px","padding":"0 0 0 0px","lineHeight":"42px","textAlign":"right","display":"inline-block"}'>姓名：</div>
...
<script>
  export default {
    ...
    async created() {
		...
		await this.$http.get('option/jingdianfenlei/jingdianfenlei').then(res => {
			if (res.data.code == 0) {
				this.jingdianfenleiOptions = res.data.data;
				this.selectOptionsList.push({name:'个人喜好',list:this.jingdianfenleiOptions,tableName: 'jingdianfenlei',check: -1})
			}
		});
      this.getFenlei();
      this.getList(1, '全部');
