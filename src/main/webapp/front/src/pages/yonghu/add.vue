...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"none"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="个人喜好" prop="jingdianfenlei">
            <el-select v-model="ruleForm.jingdianfenlei" placeholder="请选择个人喜好" :disabled=" false  ||ro.jingdianfenlei" >
              <el-option
