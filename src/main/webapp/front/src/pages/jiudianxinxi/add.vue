...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"none"}'>
    ...
    >
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="酒店类型" prop="jiudianleixing">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}'  label="星级评定" prop="xingjipingding">
            <el-select v-model="ruleForm.xingjipingding" placeholder="请选择星级评定" :disabled=" false  ||ro.xingjipingding" >
              <el-option
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="客房数量" prop="kefangshuliang">
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="客房价格" prop="kefangjiage">
			<el-input-number v-model="ruleForm.kefangjiage" placeholder="客房价格" :disabled=" false ||ro.kefangjiage"></el-input-number>
          </el-form-item>
          ...
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="酒店地址" prop="jiudiandizhi">
            <el-input v-model="ruleForm.jiudiandizhi" 
                placeholder="酒店地址" clearable :disabled=" false  ||ro.jiudiandizhi"></el-input>
          </el-form-item>
          <el-form-item :style='{"width":"100%","padding":"10px","margin":"0 0 10px","background":"none","display":"inline-block"}' label="酒店简介" prop="jiudianjianjie">
            <editor 
